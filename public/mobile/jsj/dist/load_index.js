...
/***/ function(module, exports, __webpack_require__) {
	...
	var url = "/mobile/jsj/local.json?t=" + new Date().getTime();
	var curr = localStorage.getItem("jsj_index_config");
	(0, _util.checkCacheConfig)(url, function (json) {
	    ...
	    if (json.common_css_update != curr.common_css_update) {
	        ...
	        (0, _util.loadRemoteResource)(url, function (text) {
	            /**
	             * 成功更新css资源
	             */
	            console.log("更新jsj_index的css资源成功");
	            (0, _util.appendInDom)(text, "css");
	            localStorage.setItem("jsj_index_css", text);
	            /**
	             * 更新当前配置
	             */
	            var latest = JSON.parse(localStorage.getItem("jsj_index_config")) || {};
	            ...
	            (0, _util.appendInDom)(localStorage.getItem("jsj_index_css"), "css");
	        });
	    } else {
	    ...
	    if (json.index_js_update != curr.index_js_update) {
	        ...
	        (0, _util.loadRemoteResource)(url, function (text) {
	            ...
	            (0, _util.appendInDom)(localStorage.getItem("jsj_index_js"), "js");
	        });
	    } else {
