...
/***/ function(module, exports, __webpack_require__) {
	...
	var _util = __webpack_require__(477);
	...
	var local_config_key = "global_cache_config";
	var local_js_key = "jsj_index_js";
	var local_css_key = "jsj_common_css";
	var config_url = "/mobile/jsj/local_cache?t=" + new Date().getTime();
	 ...
	 * 加载本地缓存资源
	 */
	var cssText = localStorage.getItem(local_css_key),
	    jsText = localStorage.getItem(local_js_key);
	(0, _util.appendResource)(cssText, "css");
	(0, _util.appendResource)(jsText, "js");

	/**
	 * 异步更新资源,如果资源有改变
	 */
	var curr_config = localStorage.getItem(local_config_key);
	(0, _util.checkCacheConfig)(config_url, function (json) {
	    console.log("远程获取的缓存配置信息：", json);
	    curr_config = JSON.parse(curr_config) || {};
	    var curr_css = curr_config[local_css_key];
	    var next_css = json[local_css_key];
	    /**
	     * css资源更新
	     */
	    if (!cssText || !curr_css || next_css.update != curr_css.update) {
	        (0, _util.loadRemoteResource)(next_css.loadUrl, function (text) {
	            /**
	             * 成功更新css资源
	             */
	             ...
	             * 更新当前配置
	             */
	            var latest = JSON.parse(localStorage.getItem(local_config_key)) || {};
	    ...
	    var curr_js = curr_config[local_js_key];
	    var next_js = json[local_js_key];
	    /**
	     * js资源更新
	     */
	    if (!jsText || !curr_js || next_js.update != curr_js.update) {
	        (0, _util.loadRemoteResource)(next_js.loadUrl, function (text) {
	            /**
	             * 成功更新js资源
	             */
...
/***/ function(module, exports) {
	...
	var appendResource = exports.appendResource = function appendResource(text, type) {
	    if (type == "css") {
	...
	var updateResource = exports.updateResource = function updateResource(text, type) {
